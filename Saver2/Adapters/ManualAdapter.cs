...
{
    class ManualAdapter : RecyclerView.Adapter
    {

        Context context;
        private ObservableCollection<OperationList> items;


        public ManualAdapter(Context context, ObservableCollection<OperationList> items)
        {
